...
export default function EditContacts() {
  ...
  function onSend(values) {
    console.log(values);
    navigate("/acount-salesman/add-contact/add-map");
  }
        ...
        >
          <FadeIn>
            <Text
              ...
              textAlign="center"
            >
              Adiciona contactos a sua conta
            </Text>
            <chakra.p
              mt="2"
              color="yolisa.p"
              ...
              letterSpacing="wide"
            >
              Adiciona contactos a sua conta para as pessoas entrarem em contacto com seu estabelecimento
            </chakra.p>
          </FadeIn>
        </VStack>
        <chakra.form
